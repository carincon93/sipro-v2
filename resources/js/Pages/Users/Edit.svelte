    ...
    let form = useForm({
        ...
        document_type: {
            ...
            label: documentTypes.find(
                (item) => item.value == user.document_type,
            )?.label,
        },
        ...
        participation_type: {
            ...
            label: participationTypes.find(
                (item) => item.value == user.participation_type,
            )?.label,
        },
...
<AuthenticatedLayout>
    ...
    <form on:submit|preventDefault={submit}>
        <div class="bg-white rounded shadow max-w-3xl">
            <fieldset
                class="p-8"
                disabled={canEditUsers || isSuperAdmin ? undefined : true}
            >
                <div class="mt-4">
                    <Label
                        required
