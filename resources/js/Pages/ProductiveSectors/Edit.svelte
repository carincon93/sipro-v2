...
<script>
    ...
    let canUpdateProductiveSector = $page.props.auth.user.can.find(element => element == 'productive-sectors.edit') == 'productive-sectors.edit'
    let canDeleteProductiveSector = $page.props.auth.user.can.find(element => element == 'productive-sectors.delete') == 'productive-sectors.delete'
        ...
        <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex items-center">
            {#if canDeleteProductiveSector}
                <button class="text-red-600 hover:underline" tabindex="-1" type="button" on:click={event => modal_open = true}>
                    Delete productive sector
                </button>
            {/if}
            <LoadingButton loading={sending} class="btn-indigo ml-auto" type="submit">
                Update productive sector
            </LoadingButton>
        </div>
    </form>
