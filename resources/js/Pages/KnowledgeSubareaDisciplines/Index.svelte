...
<AuthenticatedLayout>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        {#if canCreateKnowledgeSubareaDisciplines || isSuperAdmin}
            <a use:inertia href={route('knowledge-subarea-disciplines.create')} class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray transition ease-in-out duration-150 btn-indigo ml-auto">
                <div>
                    <span>{$_('Create')}</span>
        ...
        <table class="w-full whitespace-no-wrap">
            <thead>
                <tr class="text-left font-bold">
                    ...
                    <th class="px-6 pt-6 pb-4 sticky top-0 bg-white shadow-xl">Subárea de conocimiento</th>
                </tr>
            </thead>
            <tbody>
