<script>
    ...
    $: $title =
        $_('Create') + ' ' + $_('Partner organizations.singular').toLowerCase()
    ...
    function submit() {
        if (canCreatePartnerOrganizations || isSuperAdmin) {
            $form.post(
                route('calls.rdi.partner-organizations.store', [
                    call.id,
                    rdi.id,
                ]),
                {
...
<AuthenticatedLayout>
    ...
    <div class="bg-white rounded shadow max-w-3xl">
        <form on:submit|preventDefault={submit}>
            <fieldset
                class="p-8"
                disabled={canCreatePartnerOrganizations || isSuperAdmin
                    ? undefined
                    : true}
            >
                <div class="mt-4">
                ...
                {#if researchGroup}
                    ...
                    <div class="mt-4">
                        ...
                        <Input
                            ...
                            required={!researchGroup ? undefined : 'required'}
                        />
                    </div>
