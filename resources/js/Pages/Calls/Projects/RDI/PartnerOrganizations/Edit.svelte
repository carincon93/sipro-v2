<script>
    ...
    let researchGroup =
        partnerOrganization.research_group != null ? true : false
    let agreement =
        partnerOrganization.agreement_description != null ? true : false
    ...
    function submit() {
        if (canEditPartnerOrganizations || isSuperAdmin) {
            $form.put(
                route('calls.rdi.partner-organizations.update', [
                    call.id,
                    rdi.id,
    ...
    function destroy() {
        if (canDeletePartnerOrganizations || isSuperAdmin) {
            $form.delete(
                route('calls.rdi.partner-organizations.destroy', [
                    call.id,
                    rdi.id,
                    partnerOrganization.id,
                ]),
...
<AuthenticatedLayout>
    ...
    <div class="flex">
        <div class="bg-white rounded shadow max-w-3xl">
            <form on:submit|preventDefault={submit}>
                <fieldset
                    class="p-8"
                    disabled={canEditPartnerOrganizations || isSuperAdmin
                        ? undefined
                        : true}
                >
                    <div class="mt-4">
                        <Label
                            required
                            class="mb-4"
                            labelFor="partner_organization_type"
                            value="Tipo de entidad aliada"
                        />
                        <Select
                            id="partner_organization_type"
                            items={partnerOrganizationTypes}
                            bind:selectedValue={$form.partner_organization_type}
                            error={errors.partner_organization_type}
                            autocomplete="off"
                    ...
                    <div class="mt-4">
                        <Label
                            ...
                            class="mb-4"
                            labelFor="name"
                            value="Nombre de la entidad aliada/Centro de formación"
                        />
                        <Textarea
                            rows="4"
                            id="name"
                    ...
                    <div class="mt-4">
                        <Label
                            required
                            class="mb-4"
                            labelFor="legal_status"
                            value="Naturaleza de la entidad"
                        />
                        <Select
                            id="legal_status"
                            items={legalStatus}
                            bind:selectedValue={$form.legal_status}
                    ...
                    <div class="mt-4">
                        <Label
                            required
                            class="mb-4"
                            labelFor="company_type"
                            value="Tipo de empresa"
                        />
                        <Select
                            id="company_type"
                            items={companyTypes}
                            bind:selectedValue={$form.company_type}
                    ...
                    {#if agreement}
                        <div class="mt-4">
                            <Label
                                required
                                class="mb-4"
                                labelFor="agreement_description"
                                value="Descipción del convenio"
                            />
                            <Textarea
                                rows="4"
                                id="agreement_description"
                                error={errors.agreement_description}
                                bind:value={$form.agreement_description}
                                required
                            />
                        </div>
                    {/if}
                    ...
                    {#if researchGroup}
                        <div class="mt-4">
                            ...
                            <Textarea
                                ...
                                bind:value={$form.research_group}
                                required
                            />
                        </div>
                        ...
                        <div class="mt-4">
                            <Label
                                required
                                class="mb-4"
                                labelFor="gruplac_code"
                                value="Código del GrupLAC"
                            />
                            <Input
                                id="gruplac_code"
                                type="text"
                                class="mt-1 block w-full"
                                error={errors.gruplac_code}
                                placeholder="Ejemplo: COL0000000"
                                bind:value={$form.gruplac_code}
                                required={!researchGroup
                                    ? undefined
                                    : 'required'}
                            />
                        </div>
                    ...
                    <div class="mt-4">
                        <Label
                            ...
                            class="mb-4"
                            labelFor="in_kind"
                            value="Recursos en especie entidad aliada ($COP)"
                        />
                        <Input
                            id="in_kind"
                            type="number"
                            min="0"
                            class="mt-1 block w-full"
                            error={errors.in_kind}
                            placeholder="COP"
                            bind:value={$form.in_kind}
                            required
                        />
                    </div>
                    ...
                    <div class="mt-4">
                        <Label
                            required
                            class="mb-4"
                            labelFor="in_kind_description"
                            value="Descripción de los recursos en especie aportados"
                        />
                        <Textarea
                            rows="4"
                            id="in_kind_description"
                            error={errors.in_kind_description}
                            bind:value={$form.in_kind_description}
                            required
                        />
                    </div>
                    ...
                    <div class="mt-4">
                        <Label
                            required
                            class="mb-4"
                            labelFor="funds_description"
                            value="Descripción de la destinación del dinero aportado"
                        />
                        <Textarea
                            rows="4"
                            id="funds_description"
                            error={errors.funds_description}
                            bind:value={$form.funds_description}
                            required
                        />
                    </div>
                    ...
                    <div class="mt-4">
                        <Label
                            required
                            class="mb-4"
                            labelFor="knowledge_transfer_activities"
                            value="Metodología o actividades de transferencia al centro de formación"
                        />
                        <Textarea
                            rows="4"
                            id="knowledge_transfer_activities"
                            error={errors.knowledge_transfer_activities}
                            bind:value={$form.knowledge_transfer_activities}
                            required
                        />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <File
                            ...
                            class="mt-1 block w-full"
                            bind:value={$form.letter_of_intent}
                            error={errors.letter_of_intent}
                        />
                    </div>
                    ...
                    <div class="mt-4">
                        <Label
                            class="mb-4"
                            labelFor="intellectual_property"
                            value="ANEXO 8. Propiedad intelectual"
                        />
                        <File
                            ...
                            accept="application/pdf"
                            class="mt-1 block w-full"
                            bind:value={$form.intellectual_property}
                    ...
                    <h6 class="mt-20 mb-12 text-2xl" id="activities">
                        {$_('Activities.plural')}
                    </h6>
                    ...
                    <div class="bg-white rounded shadow overflow-hidden">
                        <div class="p-4">
                            <Label
                                required
                                class="mb-4"
                                labelFor="activity_id"
                                value="Relacione alguna actividad"
                            />
            ...
            <ul>
                <li>
                    <a
                        ...
                        href="#partner-organization-members"
                    >
    ...
    <DataTable class="mt-20">
        <div slot="title" id="partner-organization-members">
            {$_('Partner organization members.plural')}
        </div>
    ...
    <DataTable class="mt-20">
        <div slot="title" id="specific-objectives">
            {$_('Specific objectives.plural')}
        </div>

        <p class="mb-6" slot="caption">
            A continuación, se listan los objetivos específicos relacionados con
            la entidad aliada. Si dice 'Sin información registrada' por favor
            diríjase a las <a href="#activities" class="text-indigo-400"
                >actividades</a
            > y relacione alguna.
        </p>
