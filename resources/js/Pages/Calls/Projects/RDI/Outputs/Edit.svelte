<script>
    ...
    function submit() {
        if (canIndexRDIOutputs || isSuperAdmin) {
    ...
    function destroy() {
        if (canDeleteRDIOutputs || isSuperAdmin) {
...
<AuthenticatedLayout>
    <header class="shadow bg-white" slot="header">
        <div class="flex items-center justify-between lg:px-8 max-w-7xl mx-auto px-4 py-6 sm:px-6">
            <div>
                <h1>
                    {#if canIndexRDIOutputs || canEditRDIOutputs || isSuperAdmin}
        ...
        <form on:submit|preventDefault={submit}>
            <div class="p-8">
                ...
                {#if output.rdi_output}
                    <div class="mt-4">
                        <Label required id="minciencias_subtypology_id" value={$_('Outputs.singular')} />
            ...
            <div class="px-8 py-4 bg-gray-100 border-t border-gray-200 flex items-center sticky bottom-0">
                ...
                {/if}
                {#if canEditRDIOutputs || isSuperAdmin}
