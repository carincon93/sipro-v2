...
<script>
    ...
    let canUpdateknowledgeNetwork = $page.props.auth.user.can.find(element => element == 'knowledge-networks.edit') == 'knowledge-networks.edit'
    let canDeleteknowledgeNetwork = $page.props.auth.user.can.find(element => element == 'knowledge-networks.delete') == 'knowledge-networks.delete'
