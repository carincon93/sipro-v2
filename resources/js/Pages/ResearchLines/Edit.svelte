...
<script>
    ...
    let canUpdateResearchLine = $page.props.auth.user.can.find(element => element == 'research-lines.edit') == 'research-lines.edit'
    let canDeleteResearchLine = $page.props.auth.user.can.find(element => element == 'research-lines.delete') == 'research-lines.delete'
