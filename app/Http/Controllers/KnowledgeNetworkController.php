...
class KnowledgeNetworkController extends Controller
{
    ...
    public function store(KnowledgeNetworkRequest $request)
    {
        ...
        return redirect()->route('knowledge-networks.index')->with('success', 'The resource has been created successfully.');
    }
    ...
    public function destroy(KnowledgeNetwork $knowledgeNetwork)
    {
        ...
        return redirect()->route('knowledge-networks.index')->with('success', 'The resource has been deleted successfully.');
    }
}
