...
class BudgetProgrammaticLineController extends Controller
{
    ...
    public function store(BudgetProgrammaticLineRequest $request)
    {
        ...
        return redirect()->route('budgets-programmatic-lines.index')->with('success', __('The resource has been created successfully.'));
    }
    ...
    public function destroy(BudgetProgrammaticLine $budgetProgrammaticLine)
    {
        ...
        return redirect()->route('budgets-programmatic-lines.index')->with('success', __('The resource has been deleted successfully.'));
    }
}
